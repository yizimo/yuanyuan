...
class bomb_bullet(Base):
    # 炸弹类
    def __init__(self, screen_temp):
        Base.__init__(self, screen_temp, random.randint(
            45, 400), 0, "./images/bomb.png")
...
class supply(Base):
    ...
    def __init__(self, screen_temp):
        Base.__init__(self, screen_temp, random.randint(
            45, 400), -300, "./images/bomb_supply.png")
...
class clear_bullet(Base):
    def __init__(self, screen_temp):
        Base.__init__(self, screen_temp, random.randint(
            45, 400), 0, "./images/bullet_supply.png")
        self.alive = False
...
class Boss(EnemyPlane):
    ...
    def __create_images(self):
        ...
        self.bomb_list.append(pygame.image.load("./images/enemy3_down1.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy3_down2.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy3_down3.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy3_down4.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy3_down5.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy3_down6.png"))
...
def main():
    ...
    atlas = pygame.image.load("./images/me1.png")
    # 创建玩家飞机
    hero = Hero(screen)
    # 创建敌机群
